...
async def run_turn(session, text, store, mcp_tools, transport, images=None, nudges=None, persist=None):
    ...
    return await agent.run(session, text, registry, notify, images, nudges, persist)
